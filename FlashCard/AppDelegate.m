...
//  FlashCard
//
//  Created by Frank Martin Jr  on 2/14/15.
...
//    self.window.backgroundColor = [UIColor whiteColor];
    ...
    [[Quizlet sharedQuizlet] startWithClientID:@"PhqAKp7ppR"
                                 withSecretKey:@"NCwxBuvHMTm9m6axC2aGdE"
                               withRedirectURI:@"Wristlet:/after_oauth"];
    return YES;
}
- (BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation
{
    if ([[url scheme] isEqualToString:@"wristlet"]) {
