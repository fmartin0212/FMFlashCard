...
// Quizlet-iOS
#define COCOAPODS_POD_AVAILABLE_Quizlet_iOS
#define COCOAPODS_VERSION_MAJOR_Quizlet_iOS 0
#define COCOAPODS_VERSION_MINOR_Quizlet_iOS 2
#define COCOAPODS_VERSION_PATCH_Quizlet_iOS 0
